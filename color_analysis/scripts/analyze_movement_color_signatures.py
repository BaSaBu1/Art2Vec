"""
Cross-movement color comparison: top-20 colors, pairwise cosine/Jaccard similarity, and distinctive colors by lift.
Inputs: color/by_movement/<movement>/extraction/color_tag_counts.csv (all five movements)
Outputs: color_analysis/results/ — core_colors_top20.csv, pairwise_color_similarity.csv, distinctive_colors_lift.csv
"""
